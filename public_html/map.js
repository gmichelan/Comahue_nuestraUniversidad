function radamap(latitud, longitud, nombre, direc){
	map = new GMaps({
  div: '#mostrarMapa',
  lat: latitud,
  lng: longitud
...
function vermapa(latitud, longitud, nombre, direc){
    if(latitud=="" || longitud==""){
        $("#divOfPs-input").val(""); 
		...
		$("#muestramapa").on("pageshow", function(event, ui){radamap(latitud, longitud, nombre, direc);});
